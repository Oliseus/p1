...
int main(){
    ...
    if(l*10>=d){ // o tanque comeca cheio caso a distancia seja suficiente pra n ter q abastecer entao nao vai gastar nada
        ...
        d-=l*10;
        l = d/10; l++; // l++ é equivalente a l = l + 1, isso é para ajustar a quantidade de litros que tem que comprar, ex: para d = 15, d/10 = 1, so q 1 litro n é suficiente então boto 1 litro a mais
        if(d%10==0){
